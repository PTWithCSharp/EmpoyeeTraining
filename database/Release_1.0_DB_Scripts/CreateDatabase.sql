...
/****** Object:  Database [EmployeeTraining]    Script Date: 05/09/2025 23:18:30 ******/
CREATE DATABASE [EmployeeTraining] ON  PRIMARY 
( NAME = N'EmployeeTraining', FILENAME = N'c:\database\mssql\EmployeeTraining\EmployeeTraining.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
...
ALTER DATABASE [EmployeeTraining] SET RECOVERY SIMPLE 
GO
